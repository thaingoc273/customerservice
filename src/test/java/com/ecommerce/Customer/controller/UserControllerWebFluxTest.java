...
public class UserControllerWebFluxTest {
    ...
    @MockBean
    private UserDataCallExternalApiGenerator userDataCallExternalApiGenerator;
    ...
    void setUp() {
        ...
        successResponse = new UserResponseFullBatchSuccessErrorDto(
            HttpStatus.OK,
            new UserResponseBatchSuccessErrorDto(1, 0, 100.0f, new ArrayList<>(), new ArrayList<>())
        );

        // Initialize forbidden response
        forbiddenResponse = new UserResponseFullBatchSuccessErrorDto(
    ...
    void testCreateUserReactiveTestSuccessError_WithoutPermission() {
        ...
        webTestClient.post()
            ...
            .bodyValue(List.of(requestDTO))
            .exchange()
            .expectStatus().isOk()  // The endpoint returns 200 OK even for forbidden responses
            .expectBodyList(UserResponseFullBatchSuccessErrorDto.class)
            .hasSize(1)
